...
QT_MOC_LITERAL(3, 32, 23) // "on_pushButton_2_clicked"
    ...
    "aiWindow\0on_pushButton_clicked\0\0"
...
const QMetaObject aiWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_aiWindow.data,
      qt_meta_data_aiWindow,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *aiWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_aiWindow.stringdata0))
        return static_cast<void*>(const_cast< aiWindow*>(this));
